...
const Navigation: React.FC<NavigationProps> = ({ activeTab, onChange }) => {
  ...
  return (
    <div className="flex justify-center w-full md:w-auto">
      ...
      <div className="bg-slate-800/50 p-1 rounded-full relative border border-slate-700/50 grid grid-cols-3 gap-4 w-full max-w-xl min-w-[340px]">
        ...
        <div 
            ...
            style={{ 
                // Width = (100% - padding(0.5rem) - 2*gaps(1rem)) / 3
                // p-1 is 0.25rem * 2 = 0.5rem total horizontal padding
                // gap-4 is 1rem. 2 gaps = 2rem.
                // Total deduction = 2.5rem
