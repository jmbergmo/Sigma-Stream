          ...
          <div className="relative border-l-2 border-slate-200 ml-3 space-y-8">
            ...
            <div className="relative pl-8">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-2 mb-2">
                <h3 className="text-lg font-bold text-slate-800">v0.4</h3>
                <span className="text-xs font-medium px-2.5 py-0.5 rounded-full bg-slate-100 text-slate-600">Current</span>
              </div>
              <ul className="space-y-2 text-sm text-slate-600">
                <li className="flex items-start gap-2"><span className="mt-1.5 w-1 h-1 rounded-full bg-slate-300 flex-shrink-0"></span>Added new blog section with Espresso and Skin Care articles.</li>
                <li className="flex items-start gap-2"><span className="mt-1.5 w-1 h-1 rounded-full bg-slate-300 flex-shrink-0"></span>Refined Demo button placement and experience.</li>
                <li className="flex items-start gap-2"><span className="mt-1.5 w-1 h-1 rounded-full bg-slate-300 flex-shrink-0"></span>Fixed Monte Carlo simulation stability.</li>
                <li className="flex items-start gap-2"><span className="mt-1.5 w-1 h-1 rounded-full bg-slate-300 flex-shrink-0"></span>Removed legacy Export Report functionality.</li>
                <li className="flex items-start gap-2"><span className="mt-1.5 w-1 h-1 rounded-full bg-slate-300 flex-shrink-0"></span>Enabled Markdown support for blog posts.</li>
              </ul>
            </div>
